...
function renderTeamCard(team, services) {
    ...
    return `
        <div class="team-card rank-${dominantRank}" onclick="showTeamDetail('${formatting.escapeHtml(team.id)}')">
...
function showTeamDetail(teamId) {
    ...
    content.innerHTML = `
        <div class="team-modal-header">
            ...
            <button class="team-edit-btn" onclick="openTeamEditModal('${formatting.escapeHtml(team.id)}')">
