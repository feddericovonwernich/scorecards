 ...
 */
function parseOpenAPISummary(stdout) {
 ...
 */
function renderAPITab(openapiInfo, org, repo, defaultBranch) {
 ...
 */
async function loadSpecContent(org, repo, branch, specFile) {
 ...
 */
window.copySpecContent = async function(containerId) {
 ...
 */
function initSpecDetailsListeners() {
